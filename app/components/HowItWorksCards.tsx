...
const waveformBars = [
  { height: 18, opacity: 1 }, { height: 28, opacity: 1 }, { height: 38, opacity: 1 },
  { height: 52, opacity: 1 }, { height: 44, opacity: 1 }, { height: 60, opacity: 1 },
  { height: 72, opacity: 1 }, { height: 64, opacity: 1 }, { height: 80, opacity: 1 },
  { height: 88, opacity: 1 }, { height: 76, opacity: 1 }, { height: 92, opacity: 1 },
  { height: 84, opacity: 1 }, { height: 96, opacity: 1 }, { height: 88, opacity: 1 },
  { height: 72, opacity: 1 }, { height: 60, opacity: 1 }, { height: 48, opacity: 1 },
  { height: 36, opacity: 1 }, { height: 24, opacity: 1 }, { height: 14, opacity: 0.5 },
  { height: 10, opacity: 0.4 }, { height: 8, opacity: 0.35 }, { height: 8, opacity: 0.3 },
  { height: 8, opacity: 0.3 }, { height: 8, opacity: 0.28 }, { height: 8, opacity: 0.28 },
  { height: 8, opacity: 0.26 }, { height: 8, opacity: 0.26 }, { height: 8, opacity: 0.25 },
  { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 },
  { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 },
  { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 },
  { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 }, { height: 8, opacity: 0.25 },
  { height: 8, opacity: 0.25 }, { height: 10, opacity: 0.3 }, { height: 14, opacity: 0.4 },
  { height: 20, opacity: 0.5 }, { height: 28, opacity: 1 }, { height: 40, opacity: 1 },
  { height: 56, opacity: 1 }, { height: 68, opacity: 1 }, { height: 80, opacity: 1 },
  { height: 92, opacity: 1 }, { height: 100, opacity: 1 }, { height: 92, opacity: 1 },
  { height: 84, opacity: 1 }, { height: 76, opacity: 1 }, { height: 88, opacity: 1 },
  { height: 96, opacity: 1 }, { height: 80, opacity: 1 }, { height: 68, opacity: 1 },
  { height: 52, opacity: 1 }, { height: 36, opacity: 1 }, { height: 22, opacity: 1 },
];
...
function CallCard({ label, name, badge, totalSeconds, src, onPlay, shouldPause }: {
  ...
  useEffect(() => {
    if (shouldPause && isPlaying) { audioRef.current?.pause(); setIsPlaying(false); }
  }, [shouldPause]);
  ...
  return (
    <div className="bg-white flex flex-col" style={{ borderRadius: 24, minHeight: 340, padding: "36px 30px", boxShadow: "0 0 36px #125669" }}>
      <audio
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-sans font-semibold text-[#9ca3af] uppercase" style={{ fontSize: 8, letterSpacing: "0.10em" }}>{label}</span>
        </div>
        <div className="flex items-center gap-1 rounded-full" style={{ backgroundColor: badgeCfg.bg, border: `1px solid ${badgeCfg.border}`, padding: "2.5px 7px" }}>
      ...
      <div className="flex items-center justify-between">
        <span className="font-sans" style={{ fontSize: 13, color: "#004839", fontWeight: 500, minWidth: 40 }}>{formatTime(currentTime)}</span>
        <button
          onClick={togglePlay}
